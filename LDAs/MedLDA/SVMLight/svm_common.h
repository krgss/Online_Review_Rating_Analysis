...
typedef struct model {
  ...
  double  maxdiff;                            /* precision, up to which this 
						 model is accurate */
  int *primal;	        /* indicate whether the support vector is due to the primal constraint
...
int    parse_document(char *, WORD *, double *, long *, long *, double *, long *, long, char **, bool);
