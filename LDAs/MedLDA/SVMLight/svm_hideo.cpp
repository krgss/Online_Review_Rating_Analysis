...
int solve_dual(long n, long m, double precision, double epsilon_crit, long maxiter,
			   ...
			   double *primal, double *d, double *d0, double *ig, 
			   double *dual, double *dual_old, double *temp, long goal)
...
void linvert_matrix(double *matrix, long depth, double *inverse, double lindep_sensitivity,
					long *lin_dependent)
//double *matrix;
//long depth;
